...
| `useBlocks`               | `(options?: UseBlocksOptions \| string, locale?: string)`                       | List blocks (supports site-scoped) |
| `useBlockByName`          | `(name: string, collection?: string, locale?: string, site?: string)`           | Fetch single block by name         |
