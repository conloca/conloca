...
| site       | query | string | no       | If provided, return merged global + site-specific blocks |
...
| site       | query | string | no       | Check availability in site-specific scope                      |
...
| site       | query | string | no       | Site-first lookup: check site blocks, then global |
