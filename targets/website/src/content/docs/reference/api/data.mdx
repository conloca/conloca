...
:::note Data entries are created, updated, and deleted using the [Content API](/reference/api/content/) endpoints with
`kind: 'data'`. The Data API provides read-only lookup by name. :::
