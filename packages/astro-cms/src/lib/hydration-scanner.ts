...
export const HYDRATION_IMPORT_PATTERN =
...
export const HYDRATION_PATTERN = /withHydration\s*\(\s*\w+\s*,\s*['"](\w+)['"]\s*\)/g;
 ...
 */
export function deriveComponentPaths(puckConfigPath: string, explicitPaths?: string[]): string[] {
