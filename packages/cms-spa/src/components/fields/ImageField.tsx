    ...
    <div>
      <div className="flex">
        <input
          ...
          className="flex-1 px-3 py-2 text-sm border border-r-0 border-grey-09 dark:border-grey-04 dark:bg-grey-03 dark:text-grey-12 rounded-l focus:outline-none focus:ring-2 focus:ring-azure-04 focus:border-azure-04"
        />
        <button
          type="button"
          onClick={() => setModalOpen(true)}
          className="px-2.5 border border-grey-09 dark:border-grey-04 bg-grey-11 dark:bg-grey-03 text-grey-04 dark:text-grey-07 rounded-r hover:bg-grey-09 hover:text-grey-01 dark:hover:text-grey-12 transition-colors"
