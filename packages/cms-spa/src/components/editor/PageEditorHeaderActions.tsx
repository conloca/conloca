      ...
      <div className="flex items-center gap-2">
        {onPublish && (
          <button
            type="button"
            onClick={onPublish}
            className="px-4 py-2 bg-selected text-foreground rounded-md text-sm hover:bg-hover transition-all duration-150 flex items-center gap-1 whitespace-nowrap font-medium cursor-pointer"
            aria-label="Publish"
          >
            Publish
          </button>
        ...
        <button
          type="button"
          onClick={onPreview}
          className="px-4 py-2 rounded-md text-sm text-foreground hover:bg-hover transition-all duration-150 flex items-center gap-1 cursor-pointer"
          ...
          className={cn(
            ...
            (saveState === 'idle' || saveState === 'saving' || !saveState) &&
              (isDirty
                ...
                : 'bg-selected text-muted cursor-not-allowed opacity-60'),
          )}
        >
          {saveState === 'saved' && (
            <>
